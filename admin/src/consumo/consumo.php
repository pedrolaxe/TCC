...
?>
          ...
          <tr><td><input name="qtd_bar<?php echo $count ?>" type="number" value="0" min="0" style="width:3em"></td>
...
?>
      <!-- <form action="add_consumo.php" method="POST"> -->
          <tr><td><input name="qtd_porcao<?php echo $count ?>" type="number" value="0" min="0" style="width:3em"></td>
          <td><?php echo $nome_produto ?></td>
          <!-- <td><?php echo $preco ?></td> -->
          <!-- <td style="text-align: right; padding-right: 1vw;"> -->
