...
<div class='container'>
  ...
  <form action='faturamento.php' method='post'>
    ...
    <h2 align="center"></h2>
    <canvas id="pagamento" width="200" height="200"></canvas>
...
<script type="text/javascript">
  ...
  var canvas = document.getElementById("pagamento");
...
var data = {
  ...
  datasets: [{
    ...
    data: ['<?php echo $faturamento; ?>', '<?php echo $cartao; ?>', '<?php echo $dinheiro; ?>', '<?php echo $pix; ?>', '<?php echo $desconto; ?>'],
