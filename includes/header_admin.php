...
<header class="d-flex flex-column flex-md-row align-items-center p-3 px-md-3 mb-3 border-bottom shadow-sm" >
  ...
  <nav class="my-2 my-md-0 me-md-3" style="">
  	<a class="p-2 text-dark" href="/admin/mesas.php"><i class="fas fa-2x fa-home"></i></a>
    <a class="p-2 text-dark" style="margin-left:15px" href="/admin/delivery.php"><i class="fas fa-2x fa-motorcycle"></i>
    <a class="p-2 text-dark" style="margin-left:15px" href="/admin/config.php"><i class="fas fa-2x fa-users-cog"></i></a>
