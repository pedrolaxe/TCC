...
<main class="container-fluid">
  ...
  <div class="card mb-4 shadow">
    <div class="card-header">
      <h1 class="my-0 fw-bold"><a href='/comandas.php'><i class="fas fa-arrow-left"></i></a><b style="float: right">comanda <?php echo $nome ?></b></h1>
    </div>
    <div class="card-body">
      ...
      <a href="trocar_comanda.php?id='.$id.'">
        <button style="margin-left:4px" class="btn-lg btn-outline-success">Trocar comanda</button>
      </a>
